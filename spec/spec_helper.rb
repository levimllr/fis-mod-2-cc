...
RSpec.configure do |config|
  ...
  config.before(:each) do 
    @immortality = Power.create(name: "immortality", description: "lives forever")
    @superstrength = Power.create(name: "super strength", description: "impossibly strong")
    @extremeagility = Power.create(name: "extreme agility", description: "like an acrobat on speed")
    @wonderwoman = Heroine.create(name: "Diana Prince", super_name: "Wonder Woman", power_id: 1)
    @harleyquinn = Heroine.create(name: "Harleen Quinzel", super_name: "Harley Quinn", power_id: 2)
  end
...
# https://gist.github.com/pauljamesrussell/1353500
